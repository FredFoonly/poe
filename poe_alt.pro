...
def del = [delete char]
def ins-enter = [insert line] [push mark] [mark line] [backtab word] [begin line] [begin word] [begin mark] [pop mark]
def rep-enter = [down] [begin line] [first nonblank]
def cmd-enter = [execute]
def ins-backspace = [rubout]
def rep-backspace = [left]
def cmd-ins-backspace = [rubout]
def cmd-rep-backspace = [left]
...
def s-f9 = [copy to command] [cursor command] [begin line] [mark char] [column 19] [mark char] [delete mark] [str "e "] [execute]
def s-f10 = [copy to command] [cursor command] [begin line] [mark char] [column 19] [mark char] [delete mark] [str "cd "] [execute]
def s-minus = [char '_']
def s-equals = [char '+']
def s-lbracket = [char '{']
def s-rbracket = [char '}']
...
def a-o = [push mark] [mark char] [begin line] [split line] [begin mark] [unmark] [up] [mark line] [backtab word] [begin line] [begin word] [begin mark] [pop mark]
